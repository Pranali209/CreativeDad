...
function Home() {
    ...
    return (
        ...
        <Hero className="bg-black text-white " widthtitle="w-[70%] max-md:w-[100%] " 
            ...
            <div className="container px-10 py-10 max-md:px-2">
                <h2 className=" text-[20px] font-medium mb-8 max-md:ml-3"> {t('servicesHeading')}</h2>
                <p className="text-[29px] max-md:text-[24px] mb-16 max-md:mb-8 ml-8 max-md:ml-4">
            ...
            <Brands/>
            <div className='ml-8 max-md:ml-3 px-10 py-10 max-md:px-5'>
            <h2 className=" text-[20px] font-medium mb-8">{t('MainTitle')}</h2>
                 <div className=' flex max-md:flex-col flex-wrap justify-around'>
                      <WorkBox/>
