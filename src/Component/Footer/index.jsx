...
function Footer() {
    return (
        <footer className='bg-black max-md:p-2'>
            <section className=' max-w-[1208px] my-0 mx-auto py-0 px-[20px] bg-black'>
                <section className='bg-black'>
                    <section className='pt-[104px] pb-[120px] text-center'>
                        <h1 className='text-gray-500 mb-8px text-[43px]'>Ready to make something great?</h1>
                        <h2 className='text-white text-[43px]'>Let’s talk.</h2>
